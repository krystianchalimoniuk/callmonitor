package com.nordsecurity.callmonitor.core.designsystem.icon
...
/**
 * Call monitor icons. Material icons are [ImageVector]s, custom icons are drawable resource IDs.
 */
object CallMonitorIcons {
